...
class LOFApiEventReportsResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'realtime_published_date' => Carbon::parse($this->published_date)->setTimezone($this->event->tournament->timezone)->format(config('app.carbon_date_format')),
            'date_for_humans' => Carbon::parse($this->published_date)->setTimezone($this->event->tournament->timezone)->diffForHumans(),
